...
crud-votos/ ├── controllers/ │ └── temacontrollers.js # Lógica del controlador ├── models/ │ ├── db.js # Conexión a la base de datos SQLite │ └── temamodels.js # Métodos del modelo ├── views/ │ └── index.ejs # Plantilla principal ├── app.js # Configuración del servidor y rutas ├── package.json # Dependencias del proyecto └── README.md # Documentación del proyecto
